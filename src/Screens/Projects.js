        ...
        <div className="projectDetailsContainer">
          <div>
            <video
              ...
              controls
              poster={jungleSwap}
              src="https://bliskcloudstorage.blob.core.windows.net/videos/2c9bdc9d-6b6f-4823-844c-2a2cd5c36a86/15-May-2021-13-45-637566759460450173.mp4"
            />
          </div>
          <div>
            <h3> JungleSwap </h3>
        ...
        <div className="projectDetailsContainer">
          <div>
            <video
              ...
              controls
              poster={trackertools}
              src="https://bliskcloudstorage.blob.core.windows.net/videos/2c9bdc9d-6b6f-4823-844c-2a2cd5c36a86/15-May-2021-13-35-637566753722531829.mp4"
            />
          </div>
          <div>
            <h3> Trackertools </h3>
          ...
          <div className="projectLinksContainer">
            ...
            <div>
              <Link
                to={{
                  pathname: "https://github.com/christiangerbig/Trackertools",
                }}
                target="_blank"
                className="projectGitHubLink"
              >               
        ...
        <div className="projectDetailsContainer">
          <div>
            <video
              ...
              muted
              controls
              poster={letterShooter}
              src="https://bliskcloudstorage.blob.core.windows.net/videos/2c9bdc9d-6b6f-4823-844c-2a2cd5c36a86/15-May-2021-14-10-637566774755686276.mp4"
            />
          </div>
          <div>
            <h3> Letter Shooter </h3>
            <h4>JavaScript | HTML5 | Canvas | CSS3</h4>
            <p>
          ...
          <div className="projectLinksContainer">
            <div>
              <Link
                to={{
                  pathname: "https://christiangerbig.github.io/letter-shooter/",
                }}
                target="_blank"
                className="projectTryItLink"
              >        
            ...
            <div>
              <Link
                to={{
                  pathname: "https://github.com/christiangerbig/letter-shooter",
                }}
                target="_blank"
                className="projectGitHubLink"
              >     
